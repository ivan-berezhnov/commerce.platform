 ...
 * @endcode
 */
$settings['hash_salt'] = 'dZfkFxNQNISbzAeexayThcWz2QCti0sfeP-KI3w70J8fAljoDKWIXBh_znfwZiO6yD38Qi78sw';
...
if (file_exists($app_root . '/' . $site_path . '/settings.local.php')) {
  include $app_root . '/' . $site_path . '/setting.stage_file_proxy.php';
}

$settings['install_profile'] = 'standard';

$config_directories['sync'] = '../config/winsport/sync';
